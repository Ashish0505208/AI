...
while i != g:
    ...
    if i['A'] == "at door" and i['B'] == "at floor" and i['C'] == "at window" and i['D'] == "no banana":
        ...
        if k == 'move':
            print(f"Action: move({i['A']}, {k}, at middle)")
            i['A'] = "at middle"
        else:
            array1.remove('grasp')
        ...
        if k == 'push':
            print(f"Action: move({i['C']}, {k}, at middle)")
            i['C'] = "at middle"
        elif k == 'move':
            print(f"Action: move({i['A']}, {k}, at door)")
            i['A'] = "at door"
            array2.remove('move')
        else:
            array2.remove('grasp')
        ...
        if k == 'push':
            print(f"Action: move({i['C']}, {k}, at window)")
            i['C'] = "at window"
            array3.remove('push')
        elif k == 'climb':
            print(f"Action: move({i['B']}, {k}, on box)")
            i['B'] = "on box"
        else:
            array3.remove('grasp')
        ...
        k = 'grasp'
        print(f"Action: move({i['D']}, {k}, has banana)")
        i['D'] = "has banana"
